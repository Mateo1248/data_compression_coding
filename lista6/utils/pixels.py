...
class Pixel:
    ...
    def __sub__(self, other):
        return PixelDifference(
            clamp(np.int32(self.red) - np.int32(other.red), -32768, 32767),
            clamp(np.int32(self.green) - np.int32(other.green), -32768, 32767),
            clamp(np.int32(self.blue) - np.int32(other.blue), -32768, 32767)
        )
